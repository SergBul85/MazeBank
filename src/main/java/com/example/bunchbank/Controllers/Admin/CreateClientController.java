...
public class CreateClientController implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle resourceBundle) {
        ...
        pAddress_box.selectedProperty().addListener((
        ...
        ch_acc_box.selectedProperty().addListener((
                observableValue, oldValue, newValue) -> {
            if (newValue) {
                createCheckingAccountFlag = true;
            }
        });
        sv_acc_box.selectedProperty().addListener((
                observableValue, oldValue, newValue) -> {
            if (newValue) {
    ...
    private void createClient() {
        ...
        if (createCheckingAccountFlag) {
            craeteAccount("Checking");
        }
        //Create Savings account
        if (createSavingsAccountFlag) {
            craeteAccount("Savings");
        }
        //Create Client
    ...
    private void craeteAccount(String accountType) {
